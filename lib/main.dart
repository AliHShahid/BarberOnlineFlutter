...
import 'screens/shop/view_bookings_screen.dart';

void main() {
  runApp(BarberManagementApp());
}

class BarberManagementApp extends StatelessWidget {
  const BarberManagementApp({super.key});
